...
class AT_Meta_Box {
  ...
  public function show_field_repeater( $field, $meta ) {
      ...
      if (count($meta) > 0 && is_array($meta) ){
         foreach ($meta as $me){
           ...
           if ( in_array( $field['fields'][0]['type'], array('image','file') ) )
            $mmm = $c +1 ;
           echo '<div class="at-repater-block"><span class="at-repeater-block-title">'.$mmm.'</span><br/><table class="repeater-table" style="display: none;">';
           if ($field['inline']){
        ...
        echo'
        <span class="re-control at-re-toggle"><img src="'.$plugin_path.'/images/edit.png" alt="Edit" title="Edit"/ class="at-repeatable-edit-button"></span> 
        <span class="re-control"><img src="'.$plugin_path.'/images/remove.png" alt="'.__('Remove','mmb').'" title="'.__('Remove','mmb').'" id="remove-'.$field['id'].'" class="at-repeatable-remove-button"></span>
    ...
    echo '" alt="'.__('Add','mmb').'" title="'.__('Add','mmb').'" id="add-'.$field['id'].'" class="at-repeatable-add-button"><br/></div>';
    ...
    echo '</table><img src="'.$plugin_path.'/images/remove.png" alt="'.__('Remove','mmb').'" title="'.__('Remove','mmb').'" id="remove-'.$field['id'].'" class="at-repeatable-remove-button"></div>';
