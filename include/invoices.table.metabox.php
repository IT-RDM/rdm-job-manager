...
class Rdm_Invoice_Table_Metabox {
	...
	*/
	...
	function localize_scripts(){
		...
		$translation_array = array(
			'table_invoice_add_record_title' => apply_filters('rdm_table_invoice_add_record_title',__('Add new item','rdm-job-manager')),
			'table_invoice_line_total'		 => apply_filters('rdm_table_invoice_line_total_title',__('Line total','rdm-job-manager')),
			'table_invoice_line_quantity'	 => apply_filters('rdm_table_invoice_line_quantity_title',__('Quantity','rdm-job-manager')),
			'table_invoice_line_price'	 	 => apply_filters('rdm_table_invoice_line_price_title',__('Unit Price','rdm-job-manager')),
			'table_invoice_line_item'	 	 => apply_filters('rdm_table_invoice_line_item_title',__('Item','rdm-job-manager')),
			'table_invoice_items_on_invoice_title'	 	 => apply_filters('rdm_table_invoice_items_on_invoice_title',__('Items on invoice','rdm-job-manager')),
			'table_invoice_save_new_item_button_title'	 	 => apply_filters('rdm_table_invoice_save_new_item_button_title',__('Save','rdm-job-manager')),
			'table_invoice_cancel_new_item_button_title'	 	 => apply_filters('rdm_table_invoice_cancel_new_item_button_title',__('Cancel','rdm-job-manager')),
			'table_invoice_edit_item_popup_title'	 	 => apply_filters('rdm_table_invoice_edit_item_popup_title',__('Edit item','rdm-job-manager')),
			'table_invoice_delete_item_popup_title_are_you_sure'	 	 => apply_filters('rdm_table_invoice_delete_item_popup_title_are_you_sure',__('Are you sure','rdm-job-manager')),
			'table_invoice_delete_item_confirmation_text'	 	 => apply_filters('rdm_table_invoice_delete_item_confirmation_text',__('This item will be deleted','rdm-job-manager')),
			'table_invoice_delete_item_button_text'	 	 => apply_filters('rdm_table_invoice_delete_item_button_text',__('Delete','rdm-job-manager')),
			'table_invoice_no_data_available'	 	 => apply_filters('rdm_table_invoice_no_data_available',__('No data available','rdm-job-manager')),
			'table_invoice_loading_records'	 	 => apply_filters('rdm_table_invoice_loading_records',__('Loading records','rdm-job-manager')),
			'table_invoice_no_items_on_invoice'	 	 => apply_filters('rdm_table_invoice_no_items_on_invoice',__('No items on invoice','rdm-job-manager')),
		);
	...
	*/
	public function invoice_admin_css(){
		...
		if( $typenow=='rdm_invoice' || $typenow =='rdm_job' || $typenow == 'rdm_process' || $typenow == 'rdm_client' ){
	...
	*/
	...
	public function add_meta_box( $post_type ) {
            ...
            if ( in_array( $post_type, $post_types )) {
				add_meta_box(
					'some_meta_box_name'
					,__( 'Prepare invoice', 'rdm-job-manager' )
								...
								<tbody>
									...
									<tr>
										<td class="at-field" style="vertical-align: top;" >
											<div><?php echo apply_filters('rdm_invoice_cpt_single_private_notes_label',__('Invoice Private Notes','rdm-job-manager')); ?></div>
										...
										<td class="at-field" style="vertical-align: top;" colspan="2" >
											<div> <?php echo apply_filters('rdm_invoice_cpt_single_public_notes_label',__('Invoice public notes (visible on invoice)','rdm-job-manager'));?> </div>
											...
											<div>
												...
												<input type="checkbox" name="rdm_show_general_invoice_terms_also" id="rdm_show_general_invoice_terms_also" <?php echo $invoice_show_default_terms;?> ><?php echo apply_filters('rdm_invoice_cpt_single_show_general_terms_also_label',__('Show general terms also','rdm-job-manager'));?>
											</div>
										</td>										
									...
									<tr>
										<td class="at-field" style="vertical-align: top;" >
											<div> <?php echo apply_filters('rdm_invoice_cpt_single_invoice_status_label',__('Invoice status','rdm-job-manager'));?> </div>
											<select class="at-posts-select" name="rdm_jobs_invoices_status_field_id" id="rdm_jobs_invoices_status_field_id">
												<option value="unpaid" 		<?php selected($invoice_status,'unpaid');?> ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_status_unpaid_dropdown_option_text',__('Unpaid','rdm-job-manager'));?></option>
												<option value="paid"  		<?php selected($invoice_status,'paid');?> ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_status_paid_dropdown_option_text',__('Paid','rdm-job-manager'));?></option>
												<option value="overdue" 	<?php selected($invoice_status,'overdue');?> ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_status_overdue_dropdown_option_text',__('Overdue','rdm-job-manager'));?></option>
												<option value="cancelled"  	<?php selected($invoice_status,'cancelled');?> ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_status_cancelled_dropdown_option_text',__('Cancelled','rdm-job-manager'));?></option>
											</select>
										</td>
										
										<td class="at-field"  style="vertical-align: top;" >
											<div><?php echo apply_filters('rdm_invoice_cpt_single_invoice_to_be_paid_by_date_label',__('To be paid by date','rdm-job-manager'));?></div>
										...
										<td class="at-field"  style="vertical-align: top;" >
											<div> <?php echo apply_filters('rdm_invoice_cpt_single_invoice_paid_date_label',__('Paid Date','rdm-job-manager'));?> </div>
									...
									<tr>
										<td class="at-field" valign="top">
											<div class="at-label">
												<label for="rdm_jobs_invoices_client_field_id"><?php echo apply_filters('rdm_invoice_cpt_single_invoice_client_label',__('Client','rdm-job-manager'));?> </label>
											</div>
		
											<select class="at-posts-select" name="rdm_jobs_invoices_client_field_id" id="rdm_jobs_invoices_client_field_id">
												<option value="-1"><?php echo apply_filters('rdm_invoice_cpt_single_invoice_client_no_client_selected_option_text',__('No client selected','rdm-job-manager'));?></option>
												<?php
													//get all clients
										...
										<td class="at-field" valign="top">
											<div class="at-label">
												<label for="rdm_jobs_invoices_process_field_id">Related to process </label>
											</div>

											<span  id="rdm_jobs_invoices_process_field_id" ></span>
									...
									<tr>
										...
										<td class="at-field" valign="top" >
											...
											<div>
												<div class="rdm_discount_title"><span > <?php echo apply_filters('rdm_invoice_cpt_single_invoice_discount_label',__('Discount','rdm-job-manager'));?> </span> </div>
												...
												<div class="rdm_discount_form">
													...
													<select name="invoice_discount_type" id="invoice_discount_type"  class="rdm_invoice_discount_fields" >
														<option value="none" 	<?php selected( Rdm_Invoice_Table_Metabox::get_vat_or_discount('discountType') ,'0' );?> ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_discount_none_option_text',__('None','rdm-job-manager'));?></option>
														<option value="percent" <?php selected( Rdm_Invoice_Table_Metabox::get_vat_or_discount('discountType') , 'percent');?> ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_discount_percent_option_text',__('Percent','rdm-job-manager'));?></option>
														<option value="amount" 	<?php selected( Rdm_Invoice_Table_Metabox::get_vat_or_discount('discountType') , 'amount' );?> ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_discount_amount_option_text',__('Amount','rdm-job-manager'));?></option>
													</select>
											...
											<div>
												<div class="rdm_vat_title">
													<span ><?php echo apply_filters('rdm_invoice_cpt_single_invoice_vat_label',__('VAT','rdm-job-manager'));?> </span>    
												</div>
											...
											<div style="display:none">
												<p><?php echo apply_filters('rdm_invoice_cpt_single_invoice_total_label',__('VAT','rdm-job-manager'));?> <span id="totalInvoiceCost">0</span> </p>
											</div>
										...
										<td class="at-field" colspan="3" valign="top" style="vertical-align: top;">
												<div>
													<div class="rdm_vat_title">
														<span > <?php echo apply_filters('rdm_invoice_cpt_single_invoice_currency_label',__('Currency','rdm-job-manager'));?> </span>    
													</div>
													<div class="rdm_vat_form">
												...
												<div>
													<div class="rdm_vat_title">
														<span > <?php echo apply_filters('rdm_invoice_cpt_single_invoice_currency_position_label',__('Currency Position','rdm-job-manager'));?> </span>    
													</div>
													<div class="rdm_vat_form">
														<select  name="invoice_currency_position" id="invoice_currency_position">
															<option <?php selected( $invoice_currency_position, 'left'); ?>   value="left"><?php  echo apply_filters('rdm_invoice_cpt_single_invoice_currency_position_left_of_price_option_text',__('Left of price','rdm-job-manager'));?> </option >
															<option  <?php selected(  $invoice_currency_position, 'right'); ?>    value="right"><?php echo apply_filters('rdm_invoice_cpt_single_invoice_currency_position_right_of_price_option_text',__('Right of price','rdm-job-manager'));?> </option>
													</select>
													</div>
													<div class="rdm_clear"></div>
												</div>
									...
									<tr>
										<td class="at-field" valign="top" colspan="3">
												<input type="button" value="<?php echo apply_filters('rdm_invoice_cpt_single_invoice_apply_vat_discount_button_text',__('1. Apply VAT and discount','rdm-job-manager'));?>" class="button button-primary button-large rdm_invoice_page_buttons" id="rdm_apply_vat_btn">
												
												<input type="button" id="rdm_preview_invoice" value="<?php echo apply_filters('rdm_invoice_cpt_single_invoice_generate_invoice_button_text',__('Generate Invoice','rdm-job-manager')) ?>" class="button button-primary button-large rdm_invoice_page_buttons">
												
												
												<form method="post">
													<input type="submit" id="rdm_jobs_download_invoice" name="rdm_jobs_download_invoice" value="<?php echo apply_filters('rdm_invoice_cpt_single_invoice_download_invoice_button_text',__('3.Download Invoice','rdm-job-manager'));?>" class="button button-primary button-large rdm_invoice_page_buttons">
												</form>
	...
	*/
	public function get_client_info($invoiceID,$what){
		...
		$no_client_found = apply_filters('rdm_invoice_cpt_single_invoice_no_client_found_label',__('No Client Found','rdm-job-manager'));
