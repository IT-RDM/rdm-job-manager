			...
			<tr class="company_info"> 
				<td style="width:80%"> 
						...
						<div class="invoice_provider"> 
							<?php echo apply_filters('rdm_jobs_invoice_pdf_company_logo',__('Company','rdm-job-manager')); ?>
						</div>
				...
				<td >  
					...
					<div class="invoice_client"> 
						<?php echo apply_filters('rdm_jobs_invoice_pdf_client_title',__('Client','rdm-job-manager')); ?>
					</div>
