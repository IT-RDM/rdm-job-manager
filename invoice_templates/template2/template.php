<html>
	<head>
	<style type="text/css" >
		<?php echo apply_filters('rdm_invoice_pdf_css',$css_content); ?>
	</style>
	</head>
	<body>
			...
			<tr class="company_info"> 
				<td style="width:80%"> 
						...
						<div class="invoice_provider"> 
							<?php echo apply_filters('rdm_jobs_invoice_pdf_company_logo',__('Company','simple-job-managment')); ?>
						</div>
				
						<?php echo apply_filters('rdm_invoice_pdf_company_logo',$company_logo); ?>

						<div>	
							<span class="company_name"><?php echo apply_filters('rdm_invoice_pdf_company_title',$company_name); ?></span>
						</div>
						
						<div>
							<span class="company_name"><?php echo apply_filters('rdm_invoice_pdf_company_address',$company_address); ?></span>
						</div>			
				</td>
				<td >  
				
					<div class="invoice_client"> 
						<?php echo apply_filters('rdm_jobs_invoice_pdf_client_title',__('Client','simple-job-managment')); ?>
					</div>
					
					<span class="client_name" > 
						<?php echo apply_filters('rdm_invoice_pdf_client_first_name',$client_first_name); ?> 
						<?php echo apply_filters('rdm_invoice_pdf_client_middle_name',$client_middle_name); ?> 
						<?php echo apply_filters('rdm_invoice_pdf_client_last_name',$client_last_name); ?> 
						
					</span>
					
					<div>
						<?php echo apply_filters('rdm_invoice_pdf_client_address',$client_address); ?>
					</div>
		...
		<table class="order_items">
			...
			<tbody>
				<?php foreach($items_array as $single_item) {  ?>
					<tr>
						<td class="item_name"><?php echo apply_filters('rdm_invoice_pdf_single_item_name_value',$single_item['ItemName']); ?> </td>
						<td class="unit_cost"> <?php echo apply_filters('rdm_invoice_pdf_single_item_unit_cost_value',$single_item['ItemUnitCost']); ?> </td>
						<td class="item_quantity"><?php echo apply_filters('rdm_invoice_pdf_single_item_quantity_value',$single_item['ItemQuantity']); ?> </td>
						<td class="item_total"><?php echo apply_filters('rdm_invoice_pdf_single_item_total_cost_value',$single_item['ItemTotalCost']); ?></td>
					</tr>
				<?php } ?>
		...
		<div id="footer">
			...
			<?php if($company_name!=''){ ?>
				<div>	
					<span class="company_title"><?php echo apply_filters('rdm_invoice_pdf_company_title_footer',$company_name); ?></span>
				</div>
			<?php } ?>
