	...
	<body>
			...
			<tr class="company_info"> 
				<td style="width:80%"> 
						...
						<div class="purchase_provider"> 
							<?php echo apply_filters('rdm_jobs_purchase_pdf_company_logo',__('Company','rdm-job-manager')); ?>
						</div>
				...
				<td >  
					...
					<div class="purchase_supplier"> 
						<?php echo apply_filters('rdm_jobs_purchase_pdf_supplier_title',__('Supplier','rdm-job-manager')); ?>
					</div>
		...
		<div id="footer">
			...
			<?php if($company_mobile!=''){ ?>
				<span class="company_mobile_title"><?php echo apply_filters('rdm_purchase_pdf_email_mobile_header',__('Phone','rdm-job-manager')); ?> </span><?php echo $company_mobile; ?> 
			<?php } ?>
		</div>
