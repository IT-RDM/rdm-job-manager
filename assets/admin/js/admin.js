...
if ("dont_associate" != jQuery("select[name='rdm_supplier_asociate_with_existing_wp_account_field'] option:selected").val()) {
   ...
   rdm_jobs_functions.disable_purchase_buttons = function() {
    jQuery("input#rdm_apply_vat_btn,#rdm_preview_purchase,#rdm_jobs_download_purchase,#rdm_jobs_submit_purchase_to_supplier").prop("disabled", true)
   },
